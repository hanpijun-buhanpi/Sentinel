...
app.service('GatewayApiServiceV1', ['$http', function ($http) {
  ...
  this.deleteApi = function (api) {
    ...
    return $http({
      url: '/v1/gateway/api/delete.json',
      params: param,
      method: 'POST'
    });
  };
