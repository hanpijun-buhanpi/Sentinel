 ...
 * @since 2.0.0
 */
public class GatewayApiRuleApiPublisher implements DynamicRulePublisher<List<ApiDefinitionEntity>> {
    ...
    public void publish(String appName, List<ApiDefinitionEntity> rules) throws Exception {
        ...
        for (MachineInfo machine : set) {
            ...
            sentinelApiClient.modifyApis(appName, machine.getIp(), machine.getPort(), rules);
        }
    }
}
