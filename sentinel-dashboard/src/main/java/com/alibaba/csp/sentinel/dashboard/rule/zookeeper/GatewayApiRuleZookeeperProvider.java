 ...
 * @since 2.0.0
 */
public class GatewayApiRuleZookeeperProvider implements DynamicRuleProvider<List<ApiDefinitionEntity>> {
    ...
    public List<ApiDefinitionEntity> getRules(String appName) throws Exception {
        String zkPath = ZookeeperConfigUtil.getGatewayApiPath(appName);
