...
/**
 * Gateway flow rule Controller for manage gateway flow rules (v2).
 *
 * @author cdfive
 * @author Laiyancheng
 * @since 2.0.0
...
public class GatewayFlowRuleControllerV2 {
    ...
    @Autowired
    @Qualifier(DynamicRuleConfig.GATEWAY_FLOW_DYNAMIC_RULE_PROVIDER)
    private DynamicRuleProvider<List<GatewayFlowRuleEntity>> ruleProvider;
    @Autowired
    @Qualifier(DynamicRuleConfig.GATEWAY_FLOW_DYNAMIC_RULE_PUBLISHER)
