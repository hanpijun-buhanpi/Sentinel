...
/**
 * Gateway api Controller for manage gateway api definitions (v2).
 *
 * @author cdfive
 * @author Laiyancheng
 * @since 2.0.0
...
public class GatewayApiControllerV2 {
    ...
    @Autowired
    @Qualifier(DynamicRuleConfig.GATEWAY_API_DYNAMIC_RULE_PROVIDER)
    private DynamicRuleProvider<List<ApiDefinitionEntity>> ruleProvider;
    @Autowired
    @Qualifier(DynamicRuleConfig.GATEWAY_API_DYNAMIC_RULE_PUBLISHER)
